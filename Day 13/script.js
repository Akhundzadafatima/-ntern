...
function getWeatherClass(weatherTempp) {
  if (weatherTempp === 0) return "clear";
  if (weatherTempp >=1 && weatherTempp <= 20) return "cloud";
  if (weatherTempp >=45 && weatherTempp <= 48) return "fog";
  if (weatherTempp >= 7 && weatherTempp <= 10 || weatherTempp >= 15 && weatherTempp <= 30) return "rain";
  if (weatherTempp >= 61 && weatherTempp <= 67) return "snow";
} 